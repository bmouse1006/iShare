...
@interface FFMPEGMovieExtractor : NSObject {
...
@property (nonatomic, assign)     AVFrame *pAudioFrame;
/* Last decoded picture as UIImage */
@property (nonatomic, readonly) UIImage *currentImage;
/* Last decoded sound data */
@property (nonatomic, readonly) NSData *currentSound;
@property (nonatomic, readonly) int soundRate;
/* Size of video frame */
