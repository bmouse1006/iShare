...
- (void)viewDidLoad {
    ...
    [_actionButton setBackgroundImage:nil forState:UIControlStateNormal barMetrics:UIBarMetricsDefault];
        ...
        if ([self numberOfPhotos] > 0 && [photo underlyingImage]) {
            ...
            if ([MFMailComposeViewController canSendMail]) {
                self.actionsSheet = [[UIActionSheet alloc] initWithTitle:nil delegate:self
                                                        cancelButtonTitle:NSLocalizedString(@"actionsheet_cancel", nil) destructiveButtonTitle:nil
                                                        otherButtonTitles:NSLocalizedString(@"actionsheet_save", nil), NSLocalizedString(@"actionsheet_copy", nil), NSLocalizedString(@"actionsheet_email", nil), nil];
            } else {
                self.actionsSheet = [[UIActionSheet alloc] initWithTitle:nil delegate:self
                                                        cancelButtonTitle:NSLocalizedString(@"actionsheet_cancel", nil) destructiveButtonTitle:nil
                                                        otherButtonTitles:NSLocalizedString(@"actionsheet_save", nil), NSLocalizedString(@"actionsheet_copy", nil), nil];
            }
