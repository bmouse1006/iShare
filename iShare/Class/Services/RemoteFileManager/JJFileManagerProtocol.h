...
/*
delegate for method call back
 */
@protocol JJFileManagerDelegate <NSObject>


@end

@protocol JJFileManagerProtocol <NSObject>
...
/*
 File operation section, all method is asynchronize
 */
