...
//	filename = unescape(filename);
	...
	if (option==0) {	// rename
		...
		textObj.innerText = "Current filename "+"\""+filename+"\"";
		textObj.textContent = "Current filename "+"\""+filename+"\"";
		...
		var titleObj = document.createElement("h3");
		titleObj.innerText = "New folder";
		titleObj.textContent = "New folder";
		document.getElementById("modal-title").appendChild(titleObj);
		
		var textObj = document.createElement("a");
		textObj.innerText = "please input name for new folder";
		textObj.textContent = "please input name for new folder";
		document.getElementById("modal-text").appendChild(textObj);
		...
		var textObj = document.createElement("a");
		textObj.innerText = "Confirm to delete this file?\n" + "\""+filename+"\"";
		textObj.textContent = "Confirm to delete this file?\n" + "\""+filename+"\"";
		document.getElementById("modal-text").appendChild(textObj);
...
function deleteFile(url, params) {
	var answer = confirm("Confirm to delete this file?\n" + params['deleteFile'])
...
qq.FileUploader = function(o){
    ...
    qq.extend(this._options, {
        ...
        template: '<div class="qq-uploader">' + 
                ...
                '<div class="qq-upload-button"><img src="/root_989234ylsdfyy87e/icon_up.png" width="16" height="16"/>  Upload file</div>' +
